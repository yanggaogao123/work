...
public class Route {
	...
	public Integer getDirectionByRouteStaId(Long routeStaId) {
		for(Integer direction:routeSubMap.keySet()) {
			RouteSub routeSub=routeSubMap.get(direction);
			List<RouteSta> routeStaList=routeSub.getRouteStaList();
