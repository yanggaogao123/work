...
//elementTable所需的常量--开始
const indexOf = function(val, arr) {
    var has = -1;
...
const descendantsIds = function(id, data, parentKey, treeKey) {
    var result = [],
        compare = [id],
        length = -1;
...
//设置标志目录
const index = function(hash,data){
    var i = 0;
    while(data[i] ) {
