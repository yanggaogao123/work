...
//add by hardy for display or hide spinnerButton
if(opts.spinnerButtonHide){
	_4c7.outerWidth(0);
	_4c7.css({display:"none"});
}
//add end
...
/************timespinner modify by hardy start ************/	
...
var separators = [];
if(_4f2.indexOf(opts.separator)>0){
separators = _4f2.split(opts.separator);
...
separators.push(_4f2.substr(0,2));
separators.push(_4f2.substr(2,2));
}
...
/************timespinner modify by hardy end ************/
