<template>
    <a-row class="j-select-biz-component-box" type="flex" :gutter="8">
        ...
        <j-select-biz-component-modal-new
            v-model="selectValue"
...
<script>
import JSelectBizComponentModalNew from './JSelectBizComponentModalNew';

export default {
    name: 'JSelectBizComponentNew',
    components: { JSelectBizComponentModalNew },
    props: {
        value: {
            type: String,
            default: ''
