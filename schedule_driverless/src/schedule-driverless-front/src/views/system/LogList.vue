<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :md="6" :sm="8" v-if="tabKey === '2'">
            <a-form-item label="平台选择" :labelCol="{span: 6}" :wrapperCol="{span: 14, offset: 1}">
              <g-platform-select allowClear v-model="queryParam.platformCode" placeholder="请选择平台" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
    ...
    <a-table
      ...
      <div v-show="record.logType === 2" slot="expandedRowRender" slot-scope="record" style="margin: 0">
