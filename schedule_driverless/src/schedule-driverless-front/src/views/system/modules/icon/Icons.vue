                ...
                <ul>
                    <li v-for="icon in icons.selfIcons" :key="icon">
                        <i
                            :title="icon"
                            @click="chooseIcon(icon)"
                            :class="[{ active: activeIndex === icon }, `action-jeecg ${icon}`]"
                        >
                        </i>
                    </li>
                </ul>
...
const selfIcons = [
    'actiongongyehulianwangzhuce',
    'actionzhongyangyoubu',
    'actionjihuapaiban',
    'actiongongjiaotiaoduzhibiao',
    'actionchejujiankongfenxi',
    'actionbaobiaozhanshi',
    'actionBRTcheliangbeian',
    'actionfuzhujuecefenxi',
    'actionzidongpaiban',
    'actionlvyougongjiaoyunyingjiance',
    'actionzidongtiaodushezhi',
    'actionzidongfaban',
    'actionyunyingjiankong',
    'actionyunyingtongjibaobiao',
    'actionweixintiaoduguanli',
    'actionlvyougongjiaoyunyingfenxi',
    'actionshouye',
    'actionzhongduanwenjianfabuguanli',
    'actionzidongtiaodutongjibaobiao',
    'actionjichushuju',
    'actiongongjiaokaoping',
    'actionsuixubashi',
    'actionxitongguanli',
    'actionfuwuzhiliangjianguan',
    'actionzhucaidan',
    'actionquanxianguanli',
    'actionGISjiankong',
    'actionxianwangguihua',
    'actionyiqizhanchangguanli'
];
export default {
    name: 'Icons',
    props: {
