<template>
    <a-card :bordered="false">
        ...
        <div class="table-operator">
            <a-button type="primary" @click="showAddModal" icon="plus">新增线路文件</a-button>
        </div>
        ...
        <div>
            ...
            >
                ...
                <span slot="action" slot-scope="text, record">
                    <!-- <a-button @click="edit(record)" style="margin-left: 8px">编辑</a-button>
                    ...
                    <a-popconfirm title="确定启用？" @confirm="updateStatus(record, '0')" v-if="record.status === '1'">
                        <a-button style="margin-left: 8px">启用</a-button>
                    </a-popconfirm>
                    <a-popconfirm title="确定停止？" @confirm="updateStatus(record, '1')" v-if="record.status === '0'">
                        <a-button style="margin-left: 8px">停止</a-button>
                    </a-popconfirm> -->
                    ...
                    <div v-if="record.status == '2'">
                        <a-button>即时生效</a-button>
                        <a-popconfirm title="确定解除？" @confirm="deleteById(record)">
                            <a-button style="margin-left: 8px">解除发送</a-button>
                        </a-popconfirm>
                    </div>
                    <div v-if="record.status == '3'">
                        <a-button>生成文件</a-button>
        ...
        <Fm-plus-modal ref="modalForm" @ok="modalFormOk"></Fm-plus-modal>
    </a-card>
</template>
...
import FmPlusModal from './modules/FmPlusModal';
