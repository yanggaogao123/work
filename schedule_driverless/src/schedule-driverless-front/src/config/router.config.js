...
export const constantRouterMap = [
    ...
    {
        path: '/driverlesscars/SchedulingSimulation',
        name: 'SchedulingSimulation',
        component: () => import('@/views/driverlesscars/SchedulingSimulation')
    },
    {
        path: '/driverlesscars/SchedulingSearch',
        name: 'SchedulingSearch',
        component: () => import('@/views/driverlesscars/SchedulingSearch')
    },
    {
        path: '/driverlesscars/MonitoringDispatching',
        name: 'MonitoringDispatching',
        component: () => import('@/views/driverlesscars/MonitoringDispatching')
    },
    {
        path: '/driverlesscars/MonitoringComparison',
        name: 'MonitoringComparison',
        component: () => import('@/views/driverlesscars/MonitoringComparison')
    }
];
