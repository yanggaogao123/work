...
////根路径
// const doMian = "/gci-boot/";
////图片预览请求地址
// const imgView = "http://localhost:8080/gci-boot/sys/common/view/";

//通用控件管理
const queryTreeOrgan = (params)=>getAction("/common/sys/queryTreeOrgan",params);
const queryListRoute = (params)=>getAction("/common/sys/queryListRoute",params);
const queryPageListRoute = (params)=>getAction("/common/sys/queryPageListRoute",params);
const queryBusList = (params)=>getAction("/common/sys/queryBusList",params);
const queryHisBusList = (params)=>getAction("/common/sys/queryHisBusList",params);
...
//应用管理
const getSysAppList = (params)=>getAction("/sys/sysApp/list",params);
...
const queryOrgTreeForRole = (params)=>getAction("/sys/sysOrg/queryOrgTreeListForRole",params);
const queryTreeOrganByOrgType = (params)=>postAction("/sys/sysOrg/queryTreeOrganByOrgType",params);
...
const queryTreeOrganOrDepart = (params)=>getAction("/sys/sysOrg/queryTreeOrganOrDepart",params);
