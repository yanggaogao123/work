            ...
            <div class="box-area">
              <div class="box-name">
                总配车<a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainUpBusNum"
                  style="width: 70px"
                />
              </div>
              <div class="box-name">
                单班<a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainSingleBusUp"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="mainShifts.includes(0)">
                <span>早半班</span
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainEarlyHalfBusUp"
                  style="width: 70px"
                />
              </div>

              <div class="box-name" v-show="mainShifts.includes(1)">
                <span>晚半班</span
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainLateHalfBusUp"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="mainShifts.includes(2)">
                <span>中班</span
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainMiddleBusUp"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="mainShifts.includes(3)">
                ...
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainDoubleStopBusUp"
                  style="width: 70px"
                />
              </div>
            </div>
            ...
            <div class="box-area">
              <div class="box-name">
                总配车<a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainDownBusNum"
                  style="width: 70px"
                />
              </div>
              <div class="box-name">
                单班<a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainSingleBusDown"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="mainShifts.includes(0)">
                ...
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainEarlyHalfBusDown"
                  style="width: 70px"
                />
              </div>
              ...
              <div class="box-name" v-show="mainShifts.includes(1)">
                ...
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainLateHalfBusDown"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="mainShifts.includes(2)">
                ...
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainMiddleBusDown"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="mainShifts.includes(3)">
                ...
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.mainDoubleStopBusDown"
                  style="width: 70px"
                />
              </div>
            </div>
            ...
            <div class="box-area">
              <div class="box-name">
                总配车<a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subUpBusNum"
                  style="width: 70px"
                />
              </div>
              <div class="box-name">
                单班<a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subSingleBusUp"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="subShifts.includes(0)">
                <span>早半班</span
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subEarlyHalfBusUp"
                  style="width: 70px"
                />
              </div>

              <div class="box-name" v-show="subShifts.includes(1)">
                <span>晚半班</span
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subLateHalfBusUp"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="subShifts.includes(2)">
                <span>中班</span
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subMiddleBusUp"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="subShifts.includes(3)">
                <span>双班中停</span
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subDoubleStopBusUp"
                  style="width: 70px"
                />
              </div>
            </div>
            ...
            <div class="box-area">
              <div class="box-name">
                总配车<a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subDownBusNum"
                  style="width: 70px"
                />
              </div>
              <div class="box-name">
                单班<a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subSingleBusDown"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="subShifts.includes(0)">
                ...
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subEarlyHalfBusDown"
                  style="width: 70px"
                />
              </div>
              ...
              <div class="box-name" v-show="subShifts.includes(1)">
                ...
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subLateHalfBusDown"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="subShifts.includes(2)">
                ...
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subMiddleBusDown"
                  style="width: 70px"
                />
              </div>
              <div class="box-name" v-show="subShifts.includes(3)">
                ...
                ><a-input-number
                  :min="0"
                  :max="100000"
                  v-model="presetsInfo.subDoubleStopBusDown"
                  style="width: 70px"
                />
              </div>
            </div>
  ...
  methods: {
    ...
    async edit(record) {
      ...
      this.routeList = this.allRouteList.filter((route) =>
        route.routeName.includes(this.routeName)
      );
      this.routeId = Number(record.routeId);

      await axios
        .post(this.url.getUnionRouteInfo, { routeId: this.routeId }, { params })
        .then((res) => {
      ...
      await axios
        .get(
          `${this.url.getJoinTemplateListByRouteId}/${this.routeId}`,
          {},
          { params }
        )
        .then((res) => {
      ...
      await axios
        .get(
          `${this.url.getJoinTemplateListByRouteId}/${this.supRouteId}`,
          {},
          { params }
        )
        .then((res) => {
    ...
    handleChange(value, option) {
      ...
      axios
        .get(
          `${this.url.getJoinTemplateListByRouteId}/${value}`,
          {},
          { params }
        )
        .then((res) => {
    ...
    async createIt() {
      ...
      await axios
        .post(this.url.generateSupportSchedule, data, { params })
        .then((res) => {
          console.log(res);
          if (res.data.retCode != 0) {
            this.$message.error(res.data.retMsg);
